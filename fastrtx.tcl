if { $argc == 1 } {
    ...
    puts "Usage is: $argv0 <true|false>"
    exit 1
}
...
$tcp_ag set add793expbackoff_ true
$tcp_ag set add793jacobsonrtt_ true
$tcp_ag set add793slowstart_ true
$tcp_ag set add793additiveinc_ true
$tcp_ag set add793karnrtt_ true
$tcp_ag set add793expoinc_ true

if {$is_fastrtx == "true"} {
    $tcp_ag set add793fastrtx_ true
} elseif {$is_fastrtx == "false"} {
    $tcp_ag set add793fastrtx_ false
} else {
